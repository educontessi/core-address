...
import io.github.educontessi.core.address.adapters.in.web.v1.dataconverter.NeighborhoodInV1DataConverter;
...
public class NeighborhoodV1DataManager {
    ...
    public List<NeighborhoodV1Dto> findAll(String expand) {
        List<Neighborhood> list = cityUseCasePort.findAll(expand);
